          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
              <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
               This application is FREE and currently in the user testing phase. As such, you may encounter some bugs and updates may be required. We appreciate your understanding and patience. If you have any feedback or suggestions, we'd love to hear from you.
              </p>
            </div>
