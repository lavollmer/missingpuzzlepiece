  ...
  return (
    <>
      <div className="flex flex-col items-center text-white text-center text-xl md:text-2xl space-y-6 mt-20 px-6 py-6">
        <h1 className="text-2xl md:text-4xl text-bold mb-2">Find My Puzzle Piece</h1>
        <p className="font-bold text-md md:text-lg text-green-500 mb-6">A Free Application</p>
        ...
        <button onClick={handleFAQClick} className='bg-purple-500 hover:bg-purple-700 text-white text-md font-bold py-2 px-4 rounded'>FAQ</button>
      </div>
    </>
  );
};
