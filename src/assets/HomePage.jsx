...
const HomePage = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center text-white text-center text-xl md:text-2xl space-y-6 mt-10 px-6 py-6">
        <h1 className="text-4xl md:text-4xl text-bold">Find My <br/> Puzzle Piece</h1>
